  ...
  return (
    <div className={styles.modalOverlay} onClick={onClose}>
      <div className={styles.modalContainer} onClick={e => e.stopPropagation()}>
        <div className={styles.modalHeader} style={{ background: 'linear-gradient(135deg, #1756AA 0%, #0D1B3E 100%)', color: '#fff' }}>
          <div className={styles.modalHeaderTitleGroup}>
            <h2 className={styles.modalTitle} style={{ color: '#fff' }}>UPLOAD KYC DOCUMENTS</h2>
            <p className={styles.modalSubtitle} style={{ color: 'rgba(255,255,255,0.7)' }}>Submit your identification proofs for verification</p>
          </div>
        ...
        <div className={styles.modalBody} style={{ padding: '24px' }}>
          <div className={uploadStyles.uploadTableWrapper}>
