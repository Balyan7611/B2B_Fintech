...
const KYCViewModal = ({ isOpen, onClose, documentName, imageUrl }) => {
  ...
  return (
    <div className={styles.modalOverlay} onClick={onClose}>
      <div className={styles.modalContainer} style={{ width: '450px', borderRadius: '28px' }} onClick={e => e.stopPropagation()}>
        <div className={styles.modalHeader} style={{ padding: '20px 28px', border: 'none' }}>
        ...
        <div className={styles.modalBody} style={{ padding: '0 28px 20px', overflow: 'hidden', background: '#fff' }}>
          <div style={{ 
            background: '#F8FAFF', 
            padding: '12px', 
            borderRadius: '20px', 
        ...
        <div className={styles.modalFooter} style={{ border: 'none', padding: '0 28px 28px', justifyContent: 'center' }}>
          <button 
            className={styles.nextBtn} 
            onClick={onClose}
            style={{ background: '#1756AA', width: '100%', height: '44px', borderRadius: '14px' }}
          >
            CLOSE PREVIEW
          </button>
        </div>
